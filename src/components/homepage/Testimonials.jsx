            ...
            <div className="mx-auto max-w-full px-4 py-12 sm:px-6 lg:me-0 lg:py-16 lg:pe-0 lg:ps-8 xl:py-24">
                <div className="gap-8 lg:items-center lg:gap-16">
                    ...
                    <div className="mb-14 mx-auto flex justify-center lg:text-center text-left lg:w-1/2">
                        <div>
                            <h2 className="text-3xl font-bold tracking-tight sm:text-4xl text-black" style={{ fontFamily: "'Dancing Script', cursive" }}>
...
const TestimonialCard = ({ testimonial }) => {
    return (
        <div className="keen-slider__slide rounded-xl hover:cursor-pointer">
            <blockquote className="flex h-full flex-col bg-[url('/testimonials/testimonialImg.jpg')] bg-cover bg-center justify-between p-4 sm:p-8 lg:p-6">
                <div className="h-full w-full bg-white/60 backdrop-blur-[1px] p-3 rounded-lg">
